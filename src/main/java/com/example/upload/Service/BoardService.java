...
public class BoardService {
    ...
    public List<BoardResponse> boardList(Long memberId, Long teamId) {
        ...
        for (Boards board : boardsList) {
            ...
            List<FeedbackStatuses> feedbackStatusList =board.getFeedbackStatusList();
            BoardResponse boardResponse = BoardResponse.from(board);
            //board 하나에 대한 feedbackStatus, 에러 발생
          // List<FeedbackStatuses> feedbackStatusList = feedbackStatusRepository.findByBoardsAndUsers(board,member);
